...
FILES=init.el config.el packages.el site-lisp/my-org-config.el site-lisp/my-roam-config.el site-lisp/my-gptel-config.el site-lisp/my-walmart-utils.el site-lisp/my-walmart-utils-test.el site-lisp/walmart-utils-demo.el local-org-config.sample.el secrets-sample.el
